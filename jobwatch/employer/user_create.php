...
<div class="container">
    <div class="row">
        <div class="col-lg-12 mt-5 mb-3 p-2 bg-white">
            <div class="post-jobs">
                <h5 style="margin-top: 10px;padding-left: 20px;font-size: 14px;">Create User</h5>
            </div><!--  post-jobs -->
            <div class="nav-posts">
                <a href="post_job.php" class="btn btn-outline-primary" style="font-size: 12px;">Save</a>
                <a href="post_job.php" class="btn btn-outline-dark" style="font-size: 12px;">Cancel</a>
            </div><!-- nav-posts -->
            ...
            <div class="register-for-job">
                <form method="post" action="" style="font-size: 12px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="job_specification" value="" placeholder="Enter your email">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="login_id" class="col-sm-2 col-form-label text-right">Login ID:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="login_id" value="Login ID">
                        </div>
                    </div>

                    <div class="form-group row" style="border-bottom: 1px solid #ced4da;">
                        <label for="login_id" class="col-sm-2 col-form-label text-right">Access Right <b>Job Access</b></label>
                        <div class="col-sm-4">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" >
                                ...
                                <label class="btn btn-light" style="font-size: 12px;">
                                    <input type="radio" name="options" id="option2" autocomplete="off"> Specific Jobs
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <p>A user with specific job access is able to manage candidates in Job ads that are posted by or in collaboration with them.</p>
                        </div>
                    </div>

                    <div class="form-group row" style="border-bottom: 1px solid #ced4da;">
                        <label for="job_posting" class="col-sm-2 col-form-label text-right">Job Posting:</label>
                        <div class="col-sm-4">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" >
                                <label class="btn btn-primary active" style="font-size: 12px;">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Enabled
                                </label>
                                <label class="btn btn-light" style="font-size: 12px;">
                        ...
                        <div class="col-sm-6">
                            <p>Use job posting credits upon job ad creation.</p>
                        </div>
                    </div>

                    <div class="form-group row" style="border-bottom: 1px solid #ced4da;">
                        <label for="job_posting" class="col-sm-2 col-form-label text-right">Talent Search Utilization:</label>
                        <div class="col-sm-4">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" >
                                <label class="btn btn-primary active" style="font-size: 12px;">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Enabled
                        ...
                        <div class="col-sm-6">
                            <p>Retrieve resumes with Talent Search Credits.</p>
                        </div>
                    </div>

                    <div class="form-group row" style="border-bottom: 1px solid #ced4da;">
                        <label for="user_management" class="col-sm-2 col-form-label text-right">User management:</label>
                        <div class="col-sm-4">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" >
                                <label class="btn btn-primary active" style="font-size: 12px;">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Enabled
                        ...
                        <div class="col-sm-6">
                            <p>Manage other users within the account.</p>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="credit_management" class="col-sm-2 col-form-label text-right">Credit management:</label>
                        <div class="col-sm-4">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons" >
                                <label class="btn btn-primary active" style="font-size: 12px;">
                                    <input type="radio" name="options" id="option1" autocomplete="off" checked> Enabled
                        ...
                        <div class="col-sm-6">
                            <p>Manage credit packages within the account.</p>
                        </div>
                    </div>
