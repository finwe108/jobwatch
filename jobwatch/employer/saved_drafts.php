                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown" style="margin-top: -5px;">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           data-ewtoggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="container">
    <div class="row">
        <div class="col-lg-12 mt-5 pt-2 pl-4 bg-white">
            ...
            <div class="nav-posts">
                <a href="job_ads.php" class="btn" style="font-size:12px;border-bottom: 3px solid transparent;padding-bottom: 10px;text-align: left;color:black;">Posted Jobs</a>
                <a href="saved_drafts.php" class="btn" style="font-size:12px;border-bottom: 3px solid #17a2b8;padding-bottom: 10px;text-align: left;color:black;">Saved Drafts</a>
                <a href="" class="btn btn-info" style="margin-top: -10px;font-size:12px;">Create Job Ad</a>
            </div><!-- nav-posts -->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="welcome-job text-center">
                ...
                <h1 class="h1 text-muted" style="margin-top: -10%;">No Saved Draft</h1>
                <p class="lead text-muted font-weight-light">There are currently no job draft.
